...
-- Table for storing associations between charters and person names
...
-- Table for storing person names mentioned in saved charters
...
-- Table for storing person names mentioned in private charters
